...
sealed interface MarkBaseDesign {
    ...
    data object Deviancy: MarkBaseDesign {
        ...
        override val name: AnnotatedString = AnnotatedString("Deviancy", ChoiceTitleStyle.toSpanStyle())
    ...
    data object Inheritance: MarkBaseDesign {
        ...
        override val name: AnnotatedString = AnnotatedString("Inheritance", ChoiceTitleStyle.toSpanStyle())
        override val description: AnnotatedString = buildAnnotatedString {
    ...
    data object Rebirth: MarkBaseDesign {
        ...
        override val name: AnnotatedString = AnnotatedString("Rebirth", ChoiceTitleStyle.toSpanStyle())
        override val description: AnnotatedString = AnnotatedString("Power does you no good if you aren\'t alive to use it. With this design, if you die you will be reborn as a child to one of your marked subjects. Other bearers of this mark can also be reborn at your discretion.", SylanSpeech.toSpanStyle())
    }

    data object Borrowing: MarkBaseDesign {
        override val requirement: List<MarkSpecialization>? = null
        override val image: DrawableResource = Res.drawable.base_design_borrowing
        override val name: AnnotatedString = AnnotatedString("Borrowing", ChoiceTitleStyle.toSpanStyle())
        override val description: AnnotatedString = AnnotatedString("Any time you have sex with one of your mark bearers, you may share the effects of any number of their enchantments for one day.", NarratorSpeech.toSpanStyle())
    }

    data object Powerful: MarkBaseDesign {
        override val requirement: List<MarkSpecialization>? = null
        override val image: DrawableResource = Res.drawable.base_design_powerful
        override val name: AnnotatedString = AnnotatedString("Powerful", ChoiceTitleStyle.toSpanStyle())
        override val description: AnnotatedString = buildAnnotatedString {
            withStyle(NarratorSpeech.toSpanStyle()) {
                append("Any unspent ")
                withStyle(Points.Change.standardStyle.toSpanStyle()) { append("Change Points") }
    ...
    data object Twins: MarkBaseDesign {
        ...
        override val name: AnnotatedString = AnnotatedString("Twins", ChoiceTitleStyle.toSpanStyle())
        override val description: AnnotatedString = AnnotatedString("Your subject is magically split into two people. They will be treated as twins by society and they both have identical marks and enchantments.", ChiSpeech.toSpanStyle())
    }

    data object UltimateRolePlayer: MarkBaseDesign {
        override val requirement: List<MarkSpecialization>? = null
        override val image: DrawableResource = Res.drawable.base_design_urp
        override val name: AnnotatedString = AnnotatedString("Ultimate Role Player", ChoiceTitleStyle.toSpanStyle())
        override val description: AnnotatedString = buildAnnotatedString {
            withStyle(ChiSpeech.toSpanStyle()) {
    ...
    data object Uniform: MarkBaseDesign {
        ...
        override val name: AnnotatedString = AnnotatedString("Uniform", ChoiceTitleStyle.toSpanStyle())
        override val description: AnnotatedString = AnnotatedString("You only have to buy Activators and Mark Magic enchantments once, not individually for each subject. They also do not count towards the point limits on any individual marks.", TwinsSpeech.toSpanStyle())
    }

    data object Girl: MarkBaseDesign {
        override val requirement: List<MarkSpecialization>? = null
        override val image: DrawableResource = Res.drawable.base_design_girl
        override val name: AnnotatedString = AnnotatedString("Girl", ChoiceTitleStyle.toSpanStyle())
        override val description: AnnotatedString = AnnotatedString("With this mark, the subject\'s body will be transformed completely into that of a rather attractive young adult girl of average proportions. This is a cheap way to allow formerly male subjects to hold on to the Mark\'s power, or give females an acceptable baseline form without needing any enchantments.", NarratorSpeech.toSpanStyle())
    }
}